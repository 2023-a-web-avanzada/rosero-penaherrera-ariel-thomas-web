...
import IconChatLeft from "@/components/icons/IconChatLeft";
import IconTrashCan from "@/components/icons/IconTrashCan";
import IconEdit3 from "@/components/icons/IconEdit3";
...
export const SidebarChatButton = ({chatItem, active, onClick, onEdit, onDelete}: Props) => {
    ...
    return(
        <>
            <div onClick={hanldeClickButton} className={`flex items-center rounded-md p-3 text-sm cursor-pointer
            hover: bg-gray-500/10 ${active ? 'bg-gray-500/20' : 'bg-transparent'}`}>
                ...
                {active && !deleting && !editing &&
                    <div className="flex">
                        ...
                        mx-1 opacity-60 hover:opacity-100">
                            <IconEdit3 width={16} height={16}/>
                        </div>
                        <div onClick={() => setDeleting(true)} className="cursor-pointer
                        mx-1 opacity-60 hover:opacity-100">
                ...
                {(deleting || editing) &&
                    <div className="flex">
                        <div onClick={handleConfirmButton} className="cursor-pointer
                        mx-1 opacity-60 hover:opacity-100">
                            <IconCheck width={16} height={16}/>
                        </div>
                        <div onClick={handleCancelButton} className="cursor-pointer
                        mx-1 opacity-60 hover:opacity-100">
